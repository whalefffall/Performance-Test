...
BEGIN {
    ...
    # SPEC CPU: was require './loc_tools.pl';   # Contains find_utf8_ctype_locale()
}
...
my $utf8_locale = undef; # SPEC CPU: was find_utf8_ctype_locale();

SKIP: {
  skip 'SPEC CPU: No locales', 4*256;
