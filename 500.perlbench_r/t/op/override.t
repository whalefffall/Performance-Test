...
# Not in SPEC CPU:    require 'Config_heavy.pl'; # since runperl will need them
}
...
SKIP: { skip "SPEC CPU: No tests involving external processes", 4;
...

{
    eval {
        ...
        require 5;
        #require Text::ParseWords; # SPEC CPU2017 500.perlbench doesn't have this
        require Text::Tabs; # SPEC CPU2017 500.perlbench does have this
    };
    is $@, '';
}
...
SKIP: { skip "SPEC CPU: No tests involving external processes", 6;
