...
-r
-N C
-C /mnt/spec/benchspec/CPU/508.namd_r/run/run_base_test_mytest-m64.0000
-k -o apoa1.test.output.cmp /mnt/spec/bin/specperl /mnt/spec/bin/harness/specdiff -m -l 10 --abstol 5e-05 /mnt/spec/benchspec/CPU/508.namd_r/data/test/output/apoa1.test.output apoa1.test.output > apoa1.test.output.cmp
