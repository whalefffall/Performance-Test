...
-r
-N C
-C /mnt/spec/benchspec/CPU/531.deepsjeng_r/run/run_base_test_mytest-m64.0000
-k -o test.out.cmp /mnt/spec/bin/specperl /mnt/spec/bin/harness/specdiff -m -l 10 --obiwan /mnt/spec/benchspec/CPU/531.deepsjeng_r/data/test/output/test.out test.out > test.out.cmp
