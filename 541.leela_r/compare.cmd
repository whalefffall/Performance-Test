...
-r
-N C
-C /mnt/spec/benchspec/CPU/541.leela_r/run/run_base_test_mytest-m64.0000
-k -o test.out.cmp /mnt/spec/bin/specperl /mnt/spec/bin/harness/specdiff -m -l 10 /mnt/spec/benchspec/CPU/541.leela_r/data/test/output/test.out test.out > test.out.cmp
