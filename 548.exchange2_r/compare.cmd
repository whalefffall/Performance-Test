...
-r
-N C
-C /mnt/spec/benchspec/CPU/548.exchange2_r/run/run_base_test_mytest-m64.0000
-k -o s.txt.cmp /mnt/spec/bin/specperl /mnt/spec/bin/harness/specdiff -m -l 10 /mnt/spec/benchspec/CPU/548.exchange2_r/data/test/output/s.txt s.txt > s.txt.cmp
