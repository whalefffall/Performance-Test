...
-r
-N C
-C /root/speccpu2017/benchspec/CPU/600.perlbench_s/run/run_base_test_mytest-m64.0000
-k -o makerand.out.cmp /root/speccpu2017/bin/specperl /root/speccpu2017/bin/harness/specdiff -m -l 10 --floatcompare --nonansupport /root/speccpu2017/benchspec/CPU/500.perlbench_r/data/test/output/makerand.out makerand.out > makerand.out.cmp
-k -o test.out.cmp /root/speccpu2017/bin/specperl /root/speccpu2017/bin/harness/specdiff -m -l 10 --floatcompare --nonansupport /root/speccpu2017/benchspec/CPU/500.perlbench_r/data/test/output/test.out test.out > test.out.cmp
