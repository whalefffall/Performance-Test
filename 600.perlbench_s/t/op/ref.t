...
SKIP: { skip "SPEC CPU: No tests involving external processes", 3;
is(
  runperl(
...
SKIP: { skip "SPEC CPU: No tests involving external processes", 8;
# bug 24254
...
SKIP: { skip "SPEC CPU: No tests involving external processes", 5;
SKIP: {
