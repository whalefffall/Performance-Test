...
-r
-N C
-C /mnt/spec/benchspec/CPU/623.xalancbmk_s/run/run_base_test_mytest-m64.0000
-k -o test-test.out.cmp /mnt/spec/bin/specperl /mnt/spec/bin/harness/specdiff -m -l 10 /mnt/spec/benchspec/CPU/523.xalancbmk_r/data/test/output/test-test.out test-test.out > test-test.out.cmp
