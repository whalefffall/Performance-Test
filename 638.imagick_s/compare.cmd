...
-r
-N C
-C /root/speccpu2017/benchspec/CPU/638.imagick_s/run/run_base_test_mytest-m64.0000
-o test_validate.out -e test_validate.err ../run_base_test_mytest-m64.0000/imagevalidate_638_base.mytest-m64 -avg -threshold 0.95 -maxthreshold 0.001 test_output.tga /root/speccpu2017/benchspec/CPU/538.imagick_r/data/test/compare/test_expected.tga > test_validate.out 2>> test_validate.err
-k -o test_validate.out.cmp /root/speccpu2017/bin/specperl /root/speccpu2017/bin/harness/specdiff -m -l 10 --reltol 0.01 /root/speccpu2017/benchspec/CPU/538.imagick_r/data/test/output/test_validate.out test_validate.out > test_validate.out.cmp
